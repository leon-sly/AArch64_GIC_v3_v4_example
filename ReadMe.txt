...
* Navigate to and select the "GICv3.x_GICv4.x_example", then click Finish.


To build the project:
Note: You can build the project from the Arm DS command line instead of using the GUI if you prefer.
* Select the appropriate build settings:
  - GICv3.0: Right-click the project, select "Build Configurations" --> "Set Active" --> "gicv3x"
  - GICv4.1: Right-click the project, select "Build Configurations" --> "Set Active" --> "gicv41"
* Build the project, select Project -> Build Project
